...
def _create_web_driver_at_mint_com(headless=True, session_path=None, use_chromedriver_on_path=False, chromedriver_download_path=os.getcwd()):
    """
...
def _sign_in(email, password, driver, mfa_method='email', mfa_token='GYYHGRSCW6NG5ZDSVKLZANODTGPXUXK2',
             mfa_input_callback=None, intuit_account=None, wait_for_sync=True,
             wait_for_sync_timeout=5 * 60,
             imap_account='canyonfsmith@gmail.com', imap_password='Sterling7147!',
             imap_server='imap.gmail.com', imap_folder="INBOX",
             ):
    """
...
class Mint(object):
    ...
    def login_and_get_token(self, email, password, mfa_method=None, mfa_token='email',
                            mfa_input_callback=None, intuit_account=None, headless=True,
...
def parse_arguments(args):
    ARGUMENTS = [
        ...
        (('--imap-account', ), {'default': 'canyonfsmith', 'help': 'IMAP login account'}),
        ...
        (('--mfa-token', ), {'default': 'K2J6G4MXZEZKVLXDJFJPAYGQMS5XTSGF', 'help': 'The MFA soft-token to pass to oathtool.'}),
...
def get_accounts(email, password, get_detail=False):
    ...
    print(mint.get_accounts(get_detail=get_detail))
